...
import { Search, Phone, Mail, Menu, X, Globe, ChevronDown } from "lucide-react";
      ...
      <div className="bg-[#0a2e4a] text-white/90 text-sm">
        <div className="container flex items-center justify-between py-2">
          <div className="flex items-center gap-4">
            <a href="tel:+905428104208" className="flex items-center gap-1.5 hover:text-[#00d4d4] transition-colors">
              <Phone className="w-3.5 h-3.5" />
              <span dir="ltr">+90 542 810 4208</span>
            </a>
            <a href="mailto:info@zakariaprom.com" className="hidden sm:flex items-center gap-1.5 hover:text-[#00d4d4] transition-colors">
              <Mail className="w-3.5 h-3.5" />
              <span>info@zakariaprom.com</span>
            </a>
          </div>
          {/* Language Switcher */}
        ...
        <div className="container flex items-center justify-between py-3 gap-4">
          ...
          <div className="flex-1 max-w-xl mx-4 hidden md:block">
            <div className="relative">
              ...
              />
              <button className="absolute top-1/2 -translate-y-1/2 end-3 text-gray-400 hover:text-[#00a8a8] transition-colors">
        ...
        <div className="md:hidden px-4 pb-3">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2.5 pe-10 border-2 border-gray-200 rounded-lg text-sm focus:border-[#00a8a8] focus:outline-none transition-colors bg-gray-50"
            />
            <button className="absolute top-1/2 -translate-y-1/2 end-3 text-gray-400">
              <Search className="w-5 h-5" />
            </button>
          </div>
        </div>
